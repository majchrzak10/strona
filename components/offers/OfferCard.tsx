...
export default function OfferCard({ offer, href }: Props) {
  ...
  return (
    <article className="group overflow-hidden rounded-xl border border-zinc-100 bg-[#800020]/[0.03] transition-all duration-300 hover:-translate-y-1 hover:border-burgundy/20 hover:bg-[#800020]/[0.06] hover:shadow-[0_8px_24px_rgba(128,0,32,0.10)]">
      <Link href={href} className="block touch-manipulation text-left active:bg-black/[0.02]">
        ...
        <div className="p-4 sm:p-5">
          ...
          <p className="mt-3 text-xl font-bold leading-tight text-burgundy">
            {offer.priceLabel}
          </p>
